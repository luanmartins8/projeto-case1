  ...
  async function createContent(event) {
    try {
      ...
      await ContentsApi().createContent(
        req.titulo.value, req.autor.value, Number(req.temporadas.value), Number(req.episodios.value), req.status.value
      ).then(data => {
        return data.json()
      }).then(res => {
  ...
  async function updateContent(event) {
    try {
      ...
      await ContentsApi().updateContent(
        selectedContent.id, req.titulo.value, req.autor.value, Number(req.temporadas.value), Number(req.episodios.value), req.status.value
      )
